...
# PRELOADS
const MovementNode = preload("res://MovementNode.gd")
const DetectionNode = preload("res://DetectionNode.gd")
const ThoughtNode = preload("res://ThoughtNode.gd")
...
func set_needs():
	...
	while file_name != "":
		if file_name.ends_with(".gd"):
			...
			if script_res:
				var base_scene: PackedScene = load("res://addons/need_node_manager/NeedNode.tscn")
				if base_scene:
